...
enum UnStr {
    ...
    static func willFree(_ size: String) -> String { L("Frees \(size)", [.ru: "Освободит \(size)", .es: "Libera \(size)", .fr: "Libère \(size)", .de: "Gibt \(size) freigegeben", .ja: "\(size) を解放", .zh: "释放 \(size)", .pt: "Libera \(size)"]) }
