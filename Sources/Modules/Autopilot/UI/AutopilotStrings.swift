...
enum ApStr {
    ...
    static var a11yTagValue: String { L("Tag name", [.ru: "Имя тега", .es: "Nombre de la etiqueta", .fr: "Nom du tag", .de: "Name des Tags", .ja: "タグ名", .zh: "标签名称", .pt: "Nome da etiqueta"]) }
