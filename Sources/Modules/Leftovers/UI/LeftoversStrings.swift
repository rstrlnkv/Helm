...
enum LfStr {
    ...
    static var moduleName: String { L("Login Items & Extensions", [.ru: "Автозапуск и расширения", .es: "Inicio y extensiones", .fr: "Ouverture et extensions", .de: "Anmeldeobjekte & Erweiterungen", .ja: "ログイン項目と機能拡張", .zh: "登录项与扩展", .pt: "Itens de início e extensões"]) }
    static var summary: String { L("Startup items, extensions, and what removed apps left behind", [.ru: "Автозагрузка, расширения и остатки удалённых программ", .es: "Elementos de inicio, extensiones y restos de apps eliminadas", .fr: "Éléments de démarrage, extensions et résidus d’apps supprimées", .de: "Startobjekte, Erweiterungen und Reste entfernter Apps", .ja: "起動項目、機能拡張、削除済みアプリの残存物", .zh: "启动项、扩展，以及已删除应用的残留", .pt: "Itens de início, extensões e restos de apps removidos"]) }
    ...
    static var notScannedYet: String { L("Scan to see what apps left behind.", [.ru: "Сканируйте, чтобы увидеть, что осталось от программ.", .es: "Escanea para ver qué dejaron las apps.", .fr: "Analysez pour voir ce que les apps ont laissé.", .de: "Scannen, um zu sehen, was Apps hinterlassen haben.", .ja: "スキャンして、アプリが残したものを確認。", .zh: "扫描以查看应用留下了什么。", .pt: "Escaneie para ver o que os apps deixaram."]) }
