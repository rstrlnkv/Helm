    ...
    static var entries: [ChangelogEntry] {
        [
            ChangelogEntry(version: "0.11.1", date: "2026-08-26", items: [
                ...
                ChangeItem(kind: .fix, text: L("The line at the top of Keyboard’s page could say “Watching your words” while paused at a password field, if the day’s count still stood at zero — even though the window header above it already said “Paused”. Both agree now.")),
                ...
                ChangeItem(kind: .new, text: L("Keyboard is back in the menu-bar panel, in all three tile sizes. The big one draws the last fourteen days one by one, says roughly how much typing it saved, and carries a button that changes the period, the last change with a way to tell it never to touch that word again, and the switch for fixing as you type.")),
