    ...
    static var entries: [ChangelogEntry] {
        [
            ChangelogEntry(version: "0.10.0", date: "2026-08-09", items: [
                ...
                ChangeItem(kind: .fix, text: L("\u{201C}Something else is keeping this Mac awake\u{201D} appeared when nothing was. It was counting macOS\u{2019}s own housekeeping, which is there whenever the screen is on, so the line was true every time you could read it. Only apps you could go and quit count now.")),
