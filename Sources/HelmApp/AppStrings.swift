...
enum AppStr {
    ...
    static var flagCredit: String { L("Flag artwork: EmojiOne v2.2.7, CC BY 4.0", [.ru: "Флаги: EmojiOne v2.2.7, CC BY 4.0", .es: "Banderas: EmojiOne v2.2.7, CC BY 4.0", .fr: "Drapeaux : EmojiOne v2.2.7, CC BY 4.0", .de: "Flaggen: EmojiOne v2.2.7, CC BY 4.0", .ja: "旗のアートワーク：EmojiOne v2.2.7、CC BY 4.0", .zh: "旗帜素材：EmojiOne v2.2.7，CC BY 4.0", .pt: "Bandeiras: EmojiOne v2.2.7, CC BY 4.0"]) }
