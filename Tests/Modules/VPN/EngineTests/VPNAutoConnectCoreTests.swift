...
final class VPNAutoConnectCoreTests: XCTestCase {
    func test_launch_connects_on_first_and_not_again() {
        ...
        core.appLaunched("b", connect: { connects.append($0) })
    ...
    func test_quit_disconnects_only_when_last_leaves() {
        ...
        var disc: [String] = []
        core.appTerminated("a", disconnect: { disc.append($0) })
        XCTAssertEqual(disc, [])
        core.appTerminated("b", disconnect: { disc.append($0) })
    ...
    func test_unmapped_app_ignored() {
        ...
        var n = 0
        core.appLaunched("x", connect: { _ in n += 1 })
        XCTAssertEqual(n, 0)
    }
    func test_activeVPNs() {
        ...
        core.appTerminated("a", disconnect: { _ in })
