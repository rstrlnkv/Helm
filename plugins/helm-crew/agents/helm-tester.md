...
## When the security reviewer is also looking

Run first. You write failing tests, which is the cheapest possible form of a
finding: reproducible, permanent, and a reviewer reading them can skip the
ground you covered. Dispatched together on the same module, the two of you
independently found the same three bugs and spent about 300k tokens doing it.

If you are asked to run second, read their report first and take what they
found as pinned rather than as news: your value is the ground they did *not*
cover.
